@extends('layout')
@section('title','Coaches Requests')
@section('header_title','Coaches Requests')
@section('profile')
...
@section('content')
    <div class="items_grid">
        ...
        @if ($item->req==='undefined')
                    ...
                    <div class="card_5">
                    <div class="item_grid">
                        <a href="{{route('coaches.show',['coach'=>$item->id])}}" class="">     <img src="{{url($item->img)}}" alt=""></a>
                    <div class="subtitle">
                        {{$item->name}} 
                    </div>
                    <div class="desc">
                    ...
                    <button class="accept">
                        <a href="{{route('coaches.requests')}}">Accept</a>
                    </button>
                    <button class="reject">
                        <a href="{{route('coaches.requests')}}">Reject</a>
                    </button>
                </div>
            </div>
